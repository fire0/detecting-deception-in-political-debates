...
from transformers import WordnetSentimentTransformer

class LogRegWordnetSentiment(BaseEstimator):
    def __init__(self):
        self.params = {
            'description': 'Logistic Regression - VADER sentiment',
    ...
    def fit(self, debate_data, y, with_grid_search=False):
        ...
        train_x = WordnetSentimentTransformer(x_texts).features
    ...
    def predict(self, debate_data, proba=False):
        ...
        test_x = WordnetSentimentTransformer(x_texts).features
