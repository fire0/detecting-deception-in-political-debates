...
from transformers import LexicalPerSentenceTransformer

class LogRegLexical(BaseEstimator):
    def __init__(self):
        self.params = {
            'description': 'Logistic Regression - Lexical per sentence',
    ...
    def fit(self, debate_data, y, with_grid_search=False):
        ...
        train_x = LexicalPerSentenceTransformer(x_texts).features
    ...
    def predict(self, debate_data, proba=False):
        ...
        test_x = LexicalPerSentenceTransformer(x_texts).features
