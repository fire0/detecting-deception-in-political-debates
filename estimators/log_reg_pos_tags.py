...
from transformers.nela import POSTagsTransformer

class LogRegPOSTags(BaseEstimator):
    def __init__(self):
        self.params = {
            'description': 'Logistic Regression - POS tags',
    ...
    def fit(self, debate_data, y, with_grid_search=False):
        ...
        train_x = POSTagsTransformer(x_texts).features
    ...
    def predict(self, debate_data, proba=False):
        ...
        test_x = POSTagsTransformer(x_texts).features
