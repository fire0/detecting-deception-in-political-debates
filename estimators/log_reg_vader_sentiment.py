...
from transformers.nela import VADERSentimentTransformer

class LogRegVADERSentiment(BaseEstimator):
    def __init__(self):
        self.params = {
    ...
    def fit(self, debate_data, y, with_grid_search=False):
        ...
        train_x = VADERSentimentTransformer(x_texts).features
    ...
    def predict(self, debate_data, proba=False):
        ...
        test_x = VADERSentimentTransformer(x_texts).features
